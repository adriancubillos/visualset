    ...
    <div className="space-y-4">
      <div className="flex items-center justify-center">
        <button
          ...
          onClick={addTimeSlot}
          disabled={disabled}
          className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
          <svg
        ...
        <div className="space-y-3">
          {timeSlots.map((slot, index) => {
            ...
            return (
              <div
                key={index}
                className={`border rounded-lg p-4 ${isSlotDisabled
                  ? 'border-gray-300 bg-gray-50 opacity-60'
                  : 'border-gray-200 bg-white'
                  }`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-2">
                    <span className={`text-sm font-medium ${isSlotDisabled ? 'text-gray-500' : 'text-gray-700'
                      }`}>
                      Time Slot {index + 1}
